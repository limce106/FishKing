...
public class AreaSpawner : MonoBehaviour
{
    ...
    [SerializeField]
    private int spawnAreaCountAtStart = 5; // 게임 시작 시 최초 생성되는 구역 개수
    ...
    public void SpawnArea(bool isRandom = true)
    {
        ...
        if(isRandom == false)
        {
            clone = Instantiate(areaPrefabs[0]); // 0번 구역을 생성
        }
        else
        {
            // 현재 등록되어있는 구역 프립팹 중 임의의 구역을 생성
        ...
        areaIndex++; // zDistance만큼 더 떨어져서 생성
    }
}
